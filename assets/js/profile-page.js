(function (global) {
  ...
  var PROFILE_COPY = {
    ca: {
      ...
      subtitle: 'Consulta el teu nom, les teves millors puntuacions i l\'activitat recent en un sol lloc.',
      playerId: 'Player ID',
      storageMode: 'Mode',
      ...
      activityNote: 'Aqui veus la teva activitat recent dins de Novarena.',
    ...
    es: {
      eyebrow: 'Jugador actual',
      subtitle: 'Consulta tu nombre, tus mejores puntuaciones y la actividad reciente en un solo lugar.',
      playerId: 'Player ID',
      storageMode: 'Modo',
      ...
      activityNote: 'Aqui ves tu actividad reciente dentro de Novarena.',
    ...
    en: {
      ...
      subtitle: 'Check your name, best scores and recent activity in one place.',
      playerId: 'Player ID',
      storageMode: 'Mode',
      ...
      activityNote: 'Here you can see your recent activity in Novarena.',
    ...
    it: {
      ...
      subtitle: 'Controlla il tuo nome, i tuoi migliori punteggi e l\'attivita recente in un solo posto.',
      playerId: 'Player ID',
      ...
      activityNote: 'Qui puoi vedere la tua attivita recente in Novarena.',
